    ...
    <div className={`card card-pad ${styles.bar}`}>
      <div className={styles.info}>
        ...
        <p className={styles.desc}>
          Your data lives in your browser's localStorage. Export includes <strong>all attendance records for all months and years</strong>, plus your holiday list — so you can restore everything on another device.
        </p>
      </div>
      <div className={styles.actions}>
        ...
        >
          📥 Import Backup
          <input type="file" accept=".json" hidden onChange={handleImport} ref={importRef} />
        </motion.label>
      </div>
